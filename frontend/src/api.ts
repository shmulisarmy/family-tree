...
//   '{id}': {
//       'get': createFetch<any>({method: 'get', path: '/people/{id}'})}},
//   '': {
...
// router.people.name.put({id: 1, name: "John"});




// router.people["{id}"].get({id: 1}).then((res) => console.log(`result: ${JSON.stringify(res)}`));
